...
This repository contains a static, frontend-only UI demo for a GSoC proposal about modernizing the ESP Website communications and email system.
...
The demo also shows optional SendGrid optimization visually, but keeps queue-based scheduling central because that best matches the current ESP architecture.
